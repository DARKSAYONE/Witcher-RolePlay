...
ITEM.desc = "Обычный кусок ткани, который сложили в несколько слоев. Остановит лишь крайне слабое кровотечение."
	...
	onRun = function(item)
		...
		if client:getChar():getData("bleeding", false) then
			...
			client:doStandAction(function()
				local bloodstop = 5 + client:getChar():getAttrib("mdc", 0) * 0.1
