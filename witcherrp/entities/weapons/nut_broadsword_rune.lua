...
SWEP.ViewModel      = "models/morrowind/nordic/broadsword/v_nordic_broadsword.mdl"
SWEP.WorldModel   = "models/morrowind/nordic/broadsword/w_nordic_broadsword.mdl"
