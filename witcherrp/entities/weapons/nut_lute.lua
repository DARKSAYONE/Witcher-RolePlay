...
SWEP.WElements = {
	["element_gitara"] = { type = "Model", model = "models/lute.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(20, 2, -9), angle = Angle(-10, 103, -60), size = Vector(0.755, 0.885, 0.885), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
end
...
SWEP.Contact		= ""
SWEP.Purpose		= ""
SWEP.Instructions	= "ЛКМ - играть, R - отменить мелодию."
