	...
	SWEP.PrintName = "Стальная алебарда"
	SWEP.Slot = 2
	SWEP.SlotPos = 1
	SWEP.DrawAmmo = false
...
SWEP.ViewModel      = "models/morrowind/steel/halberd/v_steel_halberd.mdl"
SWEP.WorldModel   = "models/morrowind/steel/halberd/w_steel_halberd.mdl"
...
function SWEP:PrimaryAttack()
	local value = self.Owner:getLocalVar("stm", 0) - 40
	if (value <= 0) then
		return
	end
	if (SERVER) then
