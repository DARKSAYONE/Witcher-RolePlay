AddCSLuaFile()
	...
	SWEP.PrintName = "Улучшенная палица"
	SWEP.Slot = 2
	SWEP.SlotPos = 1
	SWEP.DrawAmmo = false
...
SWEP.ViewModel      = "models/morrowind/spiked/club/v_spiked_club.mdl"
SWEP.WorldModel   = "models/morrowind/spiked/club/w_spiked_club.mdl"
...
function SWEP:PrimaryAttack()
	...
	self.Weapon:SendWeaponAnim( ACT_VM_HITCENTER )
		...
		if trace.HitPos:Distance(self.Owner:GetShootPos()) <= 50 then
			...
			self.Weapon:EmitSound("weapons/club/morrowind_club_slash.wav")
		end
