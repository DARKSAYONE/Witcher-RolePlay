	...
	SWEP.PrintName = "Стальная булава с шипами"
	SWEP.Slot = 2
	SWEP.SlotPos = 1
	SWEP.DrawAmmo = false
...
SWEP.ViewModel      = "models/morrowind/molagbal/mace/v_molagbal_mace.mdl"
SWEP.WorldModel   = "models/morrowind/molagbal/mace/w_molagbal_mace.mdl"
