	...
	SWEP.PrintName = "Северный двуручный меч"
	SWEP.Slot = 2
	SWEP.SlotPos = 1
	SWEP.DrawAmmo = false
...
SWEP.ViewModel      = "models/morrowind/nordic/claymore/v_nordic_claymore.mdl"
SWEP.WorldModel   = "models/morrowind/nordic/claymore/w_nordic_claymore.mdl"
