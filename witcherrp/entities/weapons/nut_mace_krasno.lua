	...
	SWEP.PrintName = "Краснолюдская булава"
	SWEP.Slot = 2
	SWEP.SlotPos = 1
	SWEP.DrawAmmo = false
...
SWEP.ViewModel      = "models/morrowind/dwemer/mace/v_dwemer_mace.mdl"
SWEP.WorldModel   = "models/morrowind/dwemer/mace/w_dwemer_mace.mdl"
