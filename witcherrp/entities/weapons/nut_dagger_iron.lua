	...
	SWEP.PrintName = "Железный кортик"
	SWEP.Slot = 3
	SWEP.SlotPos = 3
	SWEP.DrawAmmo = false
...
SWEP.ViewModel      = "models/morrowind/iron/dagger/v_irondagger.mdl"
SWEP.WorldModel   = "models/morrowind/iron/dagger/w_irondagger.mdl"
