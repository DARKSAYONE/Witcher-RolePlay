...
LANGUAGE = {
	РуководствоTip = "Здесь можно узнать о RP, вселенной Ведьмака и игровых особенностях сервера.",
	spawnplace = "Место появления",
	speakingNilf = " говорит на нильфгаардском диалекте.",
	ГруппаTip = "Ознакомьтесь с правилами сервера и установите контент!",
	May = "Май",
	Hands = "Руки",
	Keys = "Ключи",
	Storage = "Контейнер",
	...
	descMinLen = "Ваше описание должно быть длиной минимум %d букв",
	model = "Модель",
	player = "Игрок",
	finish = "Завершить",
	finish = "Завершить",
	...
	contentTitle = "Коллекция аддонов",
	contentWarning = "Возможно, у Вас не установлен контент сервера. Некоторые функции могут не работать.\nВы желаете перейти на страницу скачивания контента?",
	Assign = "Присвоить",
	Freq = "Частота",
	Toggle = "Переключить",
	Use = "Использовать",
