...
do
	nut.flag.add("p", "Доступ к физгану.", function(client, isGiven)
		if (isGiven) then
	...
	nut.flag.add("t", "Доступ к тулгану.", function(client, isGiven)
		if (isGiven) then
	...
	nut.flag.add("c", "Доступ к созданию стульев.")
	nut.flag.add("C", "Доступ к созданию транспорта.")
	nut.flag.add("r", "Доступ к созданию рэгдоллов.")
	nut.flag.add("e", "Доступ к созданию пропов.")
	nut.flag.add("n", "Доступ к созданию NPC.")
	nut.flag.add("N", "Доступ к noclip.")
	nut.flag.add("b", "Доступ к меню бизнеса.")
end