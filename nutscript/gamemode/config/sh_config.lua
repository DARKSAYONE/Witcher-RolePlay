...
nut.config.add("maxAttribs", 100, "The total maximum amount of attribute points allowed.", nil, {
	data = {min = 1, max = 250},
	category = "characters"
})
nut.config.add("chatRange", 400, "The maximum distance a person's IC chat message goes to.", nil, {
	form = "Float",
...
nut.config.add("oocDelay", 60, "The delay before a player can use OOC chat again in seconds.", nil, {
...
nut.config.add("spawnTime", 1, "The time it takes to respawn.", nil, {
	data = {min = 0, max = 10000},
	category = "characters"
})
...
nut.config.add("walkSpeed", 70, "How fast a player normally walks.", function(oldValue, newValue)
...
nut.config.add("logo", "http://i79.fastpic.ru/big/2016/0607/50/ea2f57f35bda45c3bcfe2c549ec26550.png", "The icon shown on the character menu. Max size is 86x86", nil, {
	category = "appearance"
})
nut.config.add("logoURL", "http://steamcommunity.com/groups/BIBARP", "The URL opened when the icon is clicked.", nil, {
	category = "appearance"
})
